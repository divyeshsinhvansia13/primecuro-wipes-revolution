    ...
    <section className="py-16 sm:py-20 bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-brand-50 rounded-lg sm:rounded-xl border border-brand-100 flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              <Shield className="h-8 w-8 sm:h-10 sm:w-10 text-brand-600 mr-3 sm:mr-4" />
              <div>
            ...
            <a
              href="/sustainability"
              className="w-full md:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-brand-600 text-white text-center rounded-full hover:bg-brand-700 transition-colors shadow-md"
            >
