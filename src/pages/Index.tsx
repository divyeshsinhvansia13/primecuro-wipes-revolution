          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="bg-white rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all p-4 sm:p-6 border border-gray-100">
                ...
                <button className="w-full py-2 sm:py-3 bg-blue-600 text-white text-sm sm:text-base font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg">
                  Shop This Bundle
                </button>
              </div>
        ...
        <section className="py-16 sm:py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6 drop-shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <button 
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-transparent text-white text-sm sm:text-base font-medium rounded-full border border-white/30 hover:bg-white/10 transition-colors shadow-md hover:shadow-lg"
