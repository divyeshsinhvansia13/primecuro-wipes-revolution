        ...
        <section className="py-20 bg-gradient-to-b from-brand-50 to-white">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-brand-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all mb-8 transform hover:-translate-y-1">
        ...
        <section className="py-20 bg-gradient-to-b from-white to-blue-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all p-6 border border-gray-100 transform hover:-translate-y-2">
                ...
                <button className="w-full py-3 bg-brand-600 text-white font-medium rounded-lg hover:bg-brand-700 transition-colors shadow-md hover:shadow-lg">
                  Shop This Bundle
                </button>
              </div>
